...
Generated: 2026-05-25T07:19:55Z
Counts: PASS=7  WARN=2  FAIL=0  INFO=3

## mode_collapse
- **status:** PASS
- **evidence:** top anchor share = 18.26%
- **next action:** —
...
- **status:** PASS
- **evidence:** PAINS pass=100.0%, BRENK pass=89.0%, oral pass=100.0%
- **next action:** —

## biased_agonism_verification
- **status:** WARN
- **evidence:** biased_agonism_confirmed_top50=34/50; top100=36/100 at pi_clash_lock>0.5; lock-specific pi_clash field is present
