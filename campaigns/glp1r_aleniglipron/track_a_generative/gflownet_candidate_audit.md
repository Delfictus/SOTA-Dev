...
Generated: 2026-05-25T01:53:00Z
Counts: PASS=8  WARN=1  FAIL=0  INFO=3

## mode_collapse
- **status:** PASS
- **evidence:** top anchor share = 3.97%
- **next action:** —
...
- **status:** PASS
- **evidence:** PAINS pass=100.0%, BRENK pass=88.0%, oral pass=100.0%
- **next action:** —

## biased_agonism_verification
- **status:** PASS
- **evidence:** biased_agonism_confirmed_top50=50/50; top100=100/100 at pi_clash_lock>0.5; lock-specific pi_clash field is present
- **next action:** —
