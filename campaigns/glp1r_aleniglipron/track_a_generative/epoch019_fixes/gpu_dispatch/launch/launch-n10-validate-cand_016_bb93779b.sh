#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_016_bb93779b
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_016_bb93779b"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_016_bb93779b.sdf"
REPLICAS="10"
