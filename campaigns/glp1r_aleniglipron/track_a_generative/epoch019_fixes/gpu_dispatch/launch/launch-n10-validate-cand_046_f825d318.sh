#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_046_f825d318
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_046_f825d318"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_046_f825d318.sdf"
REPLICAS="10"
