#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_029_aa2820e2
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_029_aa2820e2"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_029_aa2820e2.sdf"
REPLICAS="10"
