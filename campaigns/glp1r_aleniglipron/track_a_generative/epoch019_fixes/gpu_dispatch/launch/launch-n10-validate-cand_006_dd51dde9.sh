#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_006_dd51dde9
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_006_dd51dde9"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_006_dd51dde9.sdf"
REPLICAS="10"
