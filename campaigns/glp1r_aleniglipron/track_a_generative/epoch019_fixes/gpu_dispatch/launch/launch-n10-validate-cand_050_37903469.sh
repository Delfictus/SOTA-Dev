#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_050_37903469
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_050_37903469"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_050_37903469.sdf"
REPLICAS="10"
