#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_017_1e4c4af0
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_017_1e4c4af0"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_017_1e4c4af0.sdf"
REPLICAS="10"
