#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_007_5ca33feb
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_007_5ca33feb"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_007_5ca33feb.sdf"
REPLICAS="10"
