#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_049_7c00e645
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_049_7c00e645"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_049_7c00e645.sdf"
REPLICAS="10"
