#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_010_3abc9861
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_010_3abc9861"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_010_3abc9861.sdf"
REPLICAS="10"
