#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_011_a2e0d0c7
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_011_a2e0d0c7"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_011_a2e0d0c7.sdf"
REPLICAS="10"
