#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_020_8349e315
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_020_8349e315"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_020_8349e315.sdf"
REPLICAS="10"
