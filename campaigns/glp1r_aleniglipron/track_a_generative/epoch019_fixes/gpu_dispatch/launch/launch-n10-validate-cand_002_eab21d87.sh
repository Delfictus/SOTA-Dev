#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_002_eab21d87
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_002_eab21d87"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_002_eab21d87.sdf"
REPLICAS="10"
