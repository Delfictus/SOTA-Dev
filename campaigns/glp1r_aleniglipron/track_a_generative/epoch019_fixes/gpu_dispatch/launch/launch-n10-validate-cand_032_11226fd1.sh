#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_032_11226fd1
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_032_11226fd1"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_032_11226fd1.sdf"
REPLICAS="10"
