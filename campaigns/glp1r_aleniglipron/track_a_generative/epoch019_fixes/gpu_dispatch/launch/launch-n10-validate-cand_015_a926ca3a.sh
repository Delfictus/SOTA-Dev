#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_015_a926ca3a
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_015_a926ca3a"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_015_a926ca3a.sdf"
REPLICAS="10"
