#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_031_1a1e3494
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_031_1a1e3494"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_031_1a1e3494.sdf"
REPLICAS="10"
