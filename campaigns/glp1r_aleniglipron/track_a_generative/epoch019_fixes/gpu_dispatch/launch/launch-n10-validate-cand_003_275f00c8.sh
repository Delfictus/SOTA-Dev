#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_003_275f00c8
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_003_275f00c8"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_003_275f00c8.sdf"
REPLICAS="10"
