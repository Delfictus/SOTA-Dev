#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_026_bccbe017
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_026_bccbe017"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_026_bccbe017.sdf"
REPLICAS="10"
