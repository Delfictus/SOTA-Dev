#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_013_cbe6f0c4
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_013_cbe6f0c4"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_013_cbe6f0c4.sdf"
REPLICAS="10"
