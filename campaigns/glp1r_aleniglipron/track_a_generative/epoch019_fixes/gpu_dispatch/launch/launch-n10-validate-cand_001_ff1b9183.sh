#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_001_ff1b9183
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_001_ff1b9183"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_001_ff1b9183.sdf"
REPLICAS="10"
