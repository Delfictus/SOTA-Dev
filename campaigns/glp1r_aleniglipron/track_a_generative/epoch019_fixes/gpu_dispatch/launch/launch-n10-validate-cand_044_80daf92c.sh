#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_044_80daf92c
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_044_80daf92c"
SDF_PATH="campaigns/glp1r_aleniglipron/track_a_generative/epoch019_fixes/gpu_dispatch/sdf/cand_044_80daf92c.sdf"
REPLICAS="10"
