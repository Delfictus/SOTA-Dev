#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_015_bccda098
#SBATCH --gres=gpu:1
...
CANDIDATE_ID=cand_015_bccda098
SDF_PATH=/home/diddy/Desktop/Prism4D-bio/campaigns/glp1r_aleniglipron/track_a_generative/gpu_dispatch/sdf/cand_015_bccda098.sdf
TOPOLOGY_JSON=/home/diddy/Desktop/Prism4D-bio/campaigns/glp1r_aleniglipron/track_a_generative/gpu_dispatch/topologies/cand_015_bccda098.json
REPLICAS="10"
