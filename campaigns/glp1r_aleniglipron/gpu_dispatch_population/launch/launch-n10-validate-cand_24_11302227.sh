#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_24_11302227
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_24_11302227"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_24_11302227.sdf"
REPLICAS="10"
