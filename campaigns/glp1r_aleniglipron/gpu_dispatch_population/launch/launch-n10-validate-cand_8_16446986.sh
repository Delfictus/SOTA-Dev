#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_8_16446986
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_8_16446986"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_8_16446986.sdf"
REPLICAS="10"
