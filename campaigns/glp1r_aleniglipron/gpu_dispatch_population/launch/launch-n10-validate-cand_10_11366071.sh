#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_10_11366071
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_10_11366071"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_10_11366071.sdf"
REPLICAS="10"
