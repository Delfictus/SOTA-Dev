#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_30_18744881
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_30_18744881"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_30_18744881.sdf"
REPLICAS="10"
