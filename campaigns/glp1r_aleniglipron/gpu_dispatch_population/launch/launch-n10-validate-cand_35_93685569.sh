#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_35_93685569
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_35_93685569"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_35_93685569.sdf"
REPLICAS="10"
