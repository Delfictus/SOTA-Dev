#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_38_12057019
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_38_12057019"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_38_12057019.sdf"
REPLICAS="10"
