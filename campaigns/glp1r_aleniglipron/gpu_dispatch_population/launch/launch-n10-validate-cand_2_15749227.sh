#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_2_15749227
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_2_15749227"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_2_15749227.sdf"
REPLICAS="10"
