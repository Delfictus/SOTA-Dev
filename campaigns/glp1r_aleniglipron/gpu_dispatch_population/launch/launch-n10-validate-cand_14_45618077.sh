#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_14_45618077
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_14_45618077"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_14_45618077.sdf"
REPLICAS="10"
