#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_5_42324396
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_5_42324396"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_5_42324396.sdf"
REPLICAS="10"
