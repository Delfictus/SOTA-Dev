#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_3_15047058
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_3_15047058"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_3_15047058.sdf"
REPLICAS="10"
