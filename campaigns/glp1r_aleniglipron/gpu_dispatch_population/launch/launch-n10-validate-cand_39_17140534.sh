#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_39_17140534
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_39_17140534"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_39_17140534.sdf"
REPLICAS="10"
