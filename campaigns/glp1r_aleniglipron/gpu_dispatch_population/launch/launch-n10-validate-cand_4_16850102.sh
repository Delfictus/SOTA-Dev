#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_4_16850102
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_4_16850102"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_4_16850102.sdf"
REPLICAS="10"
