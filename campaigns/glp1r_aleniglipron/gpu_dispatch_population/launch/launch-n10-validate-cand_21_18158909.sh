#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_21_18158909
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_21_18158909"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_21_18158909.sdf"
REPLICAS="10"
