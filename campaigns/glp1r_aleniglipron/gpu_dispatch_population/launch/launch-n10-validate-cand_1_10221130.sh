#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_1_10221130
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_1_10221130"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_1_10221130.sdf"
REPLICAS="10"
