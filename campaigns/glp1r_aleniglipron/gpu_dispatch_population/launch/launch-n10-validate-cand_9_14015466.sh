#!/usr/bin/env bash
#SBATCH --job-name=prism-cand_9_14015466
#SBATCH --gres=gpu:1
...
CANDIDATE_ID="cand_9_14015466"
SDF_PATH="campaigns/glp1r_aleniglipron/gpu_dispatch_population/sdf/cand_9_14015466.sdf"
REPLICAS="10"
