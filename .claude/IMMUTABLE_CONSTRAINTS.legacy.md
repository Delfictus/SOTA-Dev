...
# This is the pre-2026-04-21 version of IMMUTABLE_CONSTRAINTS.md.
# The active constraints are in IMMUTABLE_CONSTRAINTS.md.
# Preserved here for historical reference only.
# Reasons for supersession: TOS-framing language removed, architecture
# rules updated to reflect actual production state (CPU coupling path,
# L4 CUDA kernels unwired by design).
